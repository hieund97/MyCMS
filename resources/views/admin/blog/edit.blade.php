                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <div class="form-group">
                                        <input type="text" value="{{$blog->title}}" name="title" class="form-control" required></<input>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                    ...
                                    <div class="form-group">
                                        <div class="form-group">
                                            <textarea class="form-control" name="content" id="editor1" required
                                                rows="30">{{$blog->content}}</textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <button type="submit" class="btn btn-rose pull-right">Cập nhật bài viết</button>
            ...
            <div class="col-md-2">
                ...
                <div class="card card-profile">
                    ...
                    <div class="form-group">
                        ...
                        style="padding-left: 15px; padding-right: 15px;" required rows="8">{{$blog->short_decription}}</textarea>
                        </div>
                    </div>
                </div>
            </div>
