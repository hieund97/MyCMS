...
<div class="testimonials-1 section-image" style="background-image: url( {{asset('client/img/dg2.jpg')}})">
            ...
            <div class="col-md-4">
                <div class="card card-testimonial">
                    ...
                    <div class="footer">
                        ...
                        <div class="card-avatar">
                            <a href="#pablo">
                                <img class="img" src="{{ asset ('client/img/faces/card-profile4-square.jpg') }}" />
                            </a>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-md-4">
                <div class="card card-testimonial">
                    ...
                    <div class="footer">
                        ...
                        <div class="card-avatar">
                            <a href="#pablo">
                                <img class="img" src="{{ asset ('client/img/faces/card-profile2-square.jpg') }}" />
                            </a>
                        </div>
                    </div>
                </div>
