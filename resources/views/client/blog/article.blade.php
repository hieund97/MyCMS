...
@section('title', 'Blogs')
@section('content')
<div class="page-header header-filter" data-parallax="true" style="background-image: url({{ asset ('client/img/bg5.jpg') }} ); height: 200px;">
    {{-- <div class="container">
        <div class="row">
        ...
        <div class="section section-text">
            <div class="row">
                ...
                <div class="section col-md-10 col-md-offset-1">
                    <div class="col-md-4">
                        <img class="img-rounded img-responsive img-raised" alt="Raised Image" src="{{ asset ('client/img/examples/blog4.jpg') }} ">
                    </div>
                    <div class="col-md-4">
                        <img class="img-rounded img-responsive img-raised" alt="Raised Image" src="{{ asset ('client/img/examples/blog3.jpg') }} ">
                    </div>
                    <div class="col-md-4">
                        <img class="img-rounded img-responsive img-raised" alt="Raised Image" src="{{ asset ('client/img/examples/blog1.jpg') }} ">
                    </div>
                </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-2">
                                <div class="card-avatar">
                                    <a href="#pablo">
                                        <img class="img" src="{{ asset ('client/img/faces/card-profile1-square.jpg') }}">
                                    </a>
                    ...
                    <div class="media-area">
                        ...
                        <div class="media">
                            <a class="pull-left" href="#pablo">
                                <div class="avatar">
                                    <img class="media-object" src="{{ asset ('client/img/faces/card-profile4-square.jpg') }}"/>
                                </div>
                            </a>
                        ...
                        <div class="media">
                          <a class="pull-left" href="#pablo">
                              <div class="avatar">
                                 <img class="media-object" alt="Tim Picture" src="{{ asset ('client/img/faces/card-profile1-square.jpg') }}">
                              </div>
                          </a>
                          <div class="media-body">
                            ...
                            <div class="media-footer">
                             ...
                             <div class="media">
                                  <a class="pull-left" href="#pablo">
                                        <div class="avatar">
                                            <img class="media-object" alt="64x64" src="{{ asset ('client/img/faces/card-profile4-square.jpg') }}">
                                        </div>
                                  </a>
                                  <div class="media-body">
                      ...
                      <div class="media media-post">
                          <a class="pull-left author" href="#pablo">
                              <div class="avatar">
                                    <img class="media-object" alt="64x64" src="{{ asset ('client/img/faces/card-profile6-square.jpg') }}">
                              </div>
                          </a>
                          <div class="media-body">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="card card-blog">
                            <div class="card-image">
                                <a href="#pablo">
                                    <img class="img img-raised" src="{{ asset ('client/img/examples/blog8.jpg') }} "/>
                                </a>
                            </div>
                            <div class="card-content">
                    ...
                    <div class="col-md-4">
                        <div class="card card-blog">
                            <div class="card-image">
                                <a href="#pablo">
                                    <img class="img img-raised" src="{{ asset ('client/img/examples/blog7.jpg') }} "/>
                                </a>
                            </div>
